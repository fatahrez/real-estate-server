...
class RegistrationAPIView(generics.CreateAPIView):
    ...
    def post(self, request, **kwargs):
        ...
        try:
            user = User.objects.get(email=serializer_data.get("email"))
...
class SendPasswordResetEmail(APIView):
    ...
    def post(self, request):
        ...
        try:
            ...
            message = {"message": "email has been successfully sent", "token": token}
    ...
    def put(self, request, token):
        try:
            ...
            if password == confirm_password:
                ...
                message = {"message": "New password set"}
                return Response(message, status=status.HTTP_200_OK)
            else:
                message = {"message": "Passwords dont match"}
            ...
            message = {"message": "Unable to decode token"}
