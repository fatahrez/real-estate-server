...
from .views import (LoginAPIView, RegistrationAPIView, ResetPasswordView,
                    SendPasswordResetEmail, UserRetrieveUpdateAPIView)
...
urlpatterns = [
    ...
    path(
        ...
        name="send-passwordreset-email",
    ),
    path(
        "users/password/reset/<str:token>",
